...
<html>
<script src="${ctx}/js/student/changeRoomIndex.js?V=2" type="text/javascript"></script>
<body>
	...
	<div id="btn">
		<a href="#" class="easyui-linkbutton"
			...
			iconCls="icon-edit" id="changeRoom" plain="true" onclick="changeRoom()"
			text="换宿登记"></a>
	</div>
	<div id="editDiv" class="easyui-dialog" title="换宿登记"
		style="width: 600px; height: 200px"
		data-options="iconCls:'icon-save',resizable:true,modal:true,closed:true">
		<form id="editForm" style="margin-top: 10px" method="post">
			<input name="changeRoomId" id="changeRoomId" type="hidden" />
			<input name="studentId" id="studentIdEdit" type="hidden" />
			<input name="startBuildingNo" id="startBuildingNo" type="hidden" />
			<input name="startRoomNo" id="startRoomNo" type="hidden" />
			<table cellpadding="5px" style="text-align: right;">
				...
				<tr>
				<td> 
						<label for="changeTime">换宿时间:</label> 
						<input class="easyui-datebox" name="changeTime"     
        				data-options="required:true,editable:false" id="changeTime"/> 
					</td>
					<td>
